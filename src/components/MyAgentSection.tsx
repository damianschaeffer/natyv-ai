      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        duration: 0.6
          ...
          <p className="text-muted-foreground font-body text-lg max-w-3xl mx-auto mb-6 flex items-center justify-center flex-wrap gap-1">
            Multi-Modal Conversational <img src="/logos/google-gemini.svg" alt="Gemini" className="h-5 inline-block" /> Live Voice AI Agents that See, Hear, Reason, Learn, and Remember...Just Like You...
          </p>
