...
const About = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-24">
              ...
              duration: 0.8
                ...
                <div className="relative">
                  <div className="aspect-[4/5] rounded-2xl overflow-hidden border border-border/50">
                    <img src={damianProfile} alt="Damian Schaeffer, Founder of Natyv AI" className="w-full h-full object-cover object-top" />
                  </div>
                  {/* Accent decoration */}
              ...
              delay: 0.2
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.a href="https://linkedin.com/in/damianschaeffer" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="Connect on LinkedIn" whileHover={{
                    scale: 1.15,
                    ...
                    <motion.a href="https://x.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="Follow on X" whileHover={{
                    scale: 1.15,
                    backgroundColor: "hsl(var(--primary) / 0.25)"
                  }} whileTap={{
                    scale: 0.95
                    ...
                    <motion.a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="Subscribe on YouTube" whileHover={{
                    scale: 1.15,
                    backgroundColor: "hsl(var(--primary) / 0.25)"
                  }} whileTap={{
                    scale: 0.95
        ...
        <section className="container mx-auto px-6 mb-24">
          <motion.div className="max-w-3xl mx-auto text-primary" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
        ...
        <section className="container mx-auto px-6 mb-24">
          ...
          delay: 0.4
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {milestones.map((milestone, index) => <motion.div key={milestone.title} className="p-6 rounded-xl border border-border/50 bg-card/20 hover:bg-card/40 transition-colors" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
        ...
        <section className="container mx-auto px-6">
          <motion.div className="max-w-2xl mx-auto text-center p-8 rounded-2xl border border-border bg-card/30 backdrop-blur-sm" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.6
            ...
            <a href="/advisory" className="inline-flex items-center gap-2 px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-body text-sm rounded-md transition-colors">
              Book a Consultation
            </a>
          </motion.div>
        </section>
